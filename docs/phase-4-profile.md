...
อัปเดต 25 กันยายน 2026: อีเมลในโปรไฟล์ไม่บังคับแล้ว บัญชีที่สมัครโดยไม่มีอีเมลยังบันทึกชื่อ/เบอร์ได้ และผู้ใช้ลบอีเมลเดิมได้ การเพิ่มหรือเปลี่ยนเป็นอีเมลใหม่ยังต้องยืนยันที่อยู่นั้น
